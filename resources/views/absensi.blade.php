...
<html lang="en">
    ...
    <body>
        <form
            id="form"
            method="POST"
            class="pl-[18px] pr-[18px] pt-3 pb-3 flex flex-col gap-4"
        >
            @csrf
            ...
            <div class="flex gap-4 items-center">
                ...
                <button
                    type="submit"
                    class="!rounded-2xl bg-blue-200 p-2 !pr-4 !pl-4 font-bold hover:shadow transition-all ease-in-out duration-300"
                >
                    Simpan Absensi
                </button>
            </div>
